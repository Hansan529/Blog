...
export default function Introduce() {
  const childrenStyle = `[&_dt>span]:capitalize [&_dt]:flex [&_dt]:items-center [&_dt]:gap-5 [&_dt]:rounded-bl-2xl 
  [&_dt]:border-b [&_dt]:border-b-black [&_dt]:p-2.5 dark:[&_dt]:border-b-white [&_ol]:list-decimal [&_ol]:space-y-5`;
      ...
      <details>
        ...
        <dl className={"space-y-5 break-keep " + childrenStyle}>
          ...
          <dd>
            <ol>
              <li>
                기존 자바스크립트는 동적 타입으로 변수의 타입을 지정하지
                않은채로 구동이 됩니다.
              </li>
              <li>
          ...
          <dd>
            <ol>
              ...
              <li>
                ...
                클라이언트가 아닌 서버는 사용할 수 없어서 Redux-thunk,
                Redux-saga, React-query 와 같은 패키지를 사용합니다.
              </li>
            </ol>
          </dd>
          <dt>
          ...
          <dd>
            <ol>
              <li>
                Express와 같은 서버를 사용할 경우에 사용합니다. 최근에는
                Next.js를 사용하면서 사용량이 감소했습니다
              </li>
            </ol>
          </dd>
          <dt>
          ...
          <dd>
            <ol>
              ...
              <li>
                ...
                mysql보다 더 많은 기능을 지원하는 것 같다고 생각합니다
              </li>
            </ol>
          </dd>
          <dt>
