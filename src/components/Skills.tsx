...
export default function Introduce() {
  return (
    <article className="container relative mx-auto rounded-3xl p-[30px] dark:bg-[#fff]/5">
      ...
      <dl
        className="space-y-5 break-keep 
        [&>dt>span]:capitalize [&>dt]:flex [&>dt]:items-center [&>dt]:gap-5 [&>dt]:rounded-bl-2xl [&>dt]:border-b [&>dt]:border-b-black [&>dt]:p-2.5 dark:[&>dt]:border-b-white"
      >
        <dt>
        ...
        <dd>
          <p>
            React 개발로 인해 CSR 방식으로 SPA 과 같은 컴포넌트 개발을 숙달할 수
            있었습니다. 사용자가 이용하면서 새로고침 현상 없이 부드럽게 사용할
            수 있다는 장점이 있습니다.
          </p>
          <p>
        ...
        <dd>
          ...
          <p>
            원치않은 결과를 예방하기 위해 타입을 명명해서 일치하는 요소만 대입이
            가능하도록 해주는 역할을 합니다.
          </p>
        </dd>
        <dt>
        ...
        <dd>
          ...
          <p>
            특정 정보나 상태를 저장하거나 불러오기 위해 사용합니다. 클라이언트가
            아닌 서버는 사용할 수 없어서 Redux-thunk, Redux-saga, React-query 와
            같은 패키지를 사용합니다.
          </p>
        </dd>
        <dt>
        ...
        <dd>
          <p>
            CSS 전처리기로 클래스 속 클래스를 지정하거나, @mixin으로 재사용성을
            높이고 스타일링의 속도를 높여주기 때문에 사용합니다.
          </p>
        </dd>
        <dt>
        ...
        <dd>
          <p>
            NoSQL 데이터베이스로 데이터를 JSON 문서로 저장합니다. 모델 안에 다른
            모델을 복제하여 참조할 수 있습니다.
          </p>
          <p>
        ...
        <dd>
          ...
          <p>또한 Primary key, 외래키와 같이 관계를 정의합니다.</p>
        </dd>
        <dt>
        ...
        <dd>
          <p>
            ...
            않으며, 체계적인 관리가 필요한 페이지의 경우 git-flow 브랜치 전략을
            사용해 커밋을 진행합니다.
          </p>
        </dd>
      </dl>
